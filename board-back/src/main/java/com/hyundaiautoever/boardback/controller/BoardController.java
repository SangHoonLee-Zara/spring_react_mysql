...
public class BoardController {
    ...
    public ResponseEntity<? super PostCommentResponseDto> postCommnet(
        ...
        @PathVariable("boardNumber") Integer boardNumner,
        @AuthenticationPrincipal String email
    ) {
        ResponseEntity<? super PostCommentResponseDto> response = boardService.postComment(requestBody, boardNumner, email);
        return response;
    }
