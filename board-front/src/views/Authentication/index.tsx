        ...
        <div className='auth-card-box'>
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-consent-box'>
              <div className='auth-checkbox' onClick={onAgreedPersonalClickHandler}>
                <div className={`icon ${agreedPersonal ? 'check-round-fill-icon' : 'check-ring-light-icon'} check-round-fill-icon`}></div>
              </div>
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'ZARAD BOARD 입니다.'}</div>
            </div>
          </div>
        </div>
