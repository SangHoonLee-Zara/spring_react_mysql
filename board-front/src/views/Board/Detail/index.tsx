...
import { IncreaseViewCountRequest, deleteBoardRequest, getBoardRequest, getCommentListRequest, getFavoriteListRequest, postCommentRequest, putFavoriteRequest } from 'apis';
...
export default function BoardDetail() {
  ...
  const BoardDetailTop = () => {
    ...
    //          effect: 게시물 번호 path varaibale이 바뀔때 마다 게시물 불러오기          //
    useEffect(() => {
      if (!boardNumber) {
        navigate(MAIN_PATH());
        return;
    ...
    return (
      <div id='board-detail-top'>
        <div className='board-detail-top-header'>
          ...
          <div className='board-detail-top-subbox'>
  ...
  //          effect: 게시물 번호 path varaibale이 바뀔때 마다 게시물 조회수 증가          //
  let effectFlag =true;
  useEffect(() => {
    if (!boardNumber) return;
    if (effectFlag) {
