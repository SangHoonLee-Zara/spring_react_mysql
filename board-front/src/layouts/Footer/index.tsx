...
export default function Footer() {
  ...
  const onInstaIconButtonClickHander = () => {
        ...
        <div className='footer-container'>
            <div className='footer-top'>
                ...
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'zarad0525@naver.com'}</div>
                    <div className='icon-button' onClick={onInstaIconButtonClickHander}>
